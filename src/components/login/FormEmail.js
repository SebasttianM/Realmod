...
const SignupSchema = Yup.object().shape({
    ...
    password: Yup.string()
        .min(10, "El password es muy corto")
        ...
        >
            {({ errors, touched }) => (
                <Form className="flex flex-col mt-6 gap-3 mx-auto ">
                    <Field className='text-center align-middle m-1 w-2/3 mx-auto border-2 border-caribbean-green-500
                    ...
                    {errors.email && touched.email ? (
                        <div className="text-red-500 shadow-lg text-center ">{errors.email}</div>
                    ) : null}
                    <Field className='text-center align-middle m-1 w-2/3 mx-auto border-2 border-caribbean-green-500
                    rounded-lg border-opacity-40'
                        name="password"
                    ...
                    {errors.password && touched.password ? (
                        <div className="text-red-500 shadow-lg text-center ">{errors.password}</div>
                    ) : null}
