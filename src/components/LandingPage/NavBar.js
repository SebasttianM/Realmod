...
const NavBar = () => {
    return (
        <div>
            <nav className="w-full flex justify-evenly items-center   border-b-slate-200 ">
                <div>
                    <img
                        className=""
                        ...
                        alt=""
                    />
                    <h3 className="top-3 l-10 absolute text-black font-bold text-3xl ml-20">
                        Realmod
                    </h3>
                </div>
                <div className="flex gap-8 text-base text-black  font-medium  ">
                    <a
                        href="Home "
                        className="hover:text-caribbean-green-400 hover:border-b-2 hover:border-caribbean-green-400
                  transition-colors delay-200"
                    >
                        Home
                    </a>
                    <a
